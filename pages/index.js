...
const Home = () => {
  ...
  const choosedReciper = (resiper) => {
    choosedMenuHandler(resiper)
    localStorage.setItem('recipe', resiper)
  }
  ...
  const FAQestions = [
    ...
    {
      id: '3',
      question: 'Опис продукту',
      answer: `План харчування складає середземноморський раціон, 
      який являється по суті збалансованим здоровим харчуванням. Він не є протипоказаний 
      і не несе загрози для здоров’я. Продукт являє собою файл у якому описано 21-денний раціон із описом приготування та кількості продуктів.`
    },
    {
      id: '4',
      question: 'Яка вартість раціону?',
      answer: 'Ціна раціону складає 499грн'
    }
  ]
  const innerTitles = [
                  ...
                  choosedMenu !== null
                    ? (
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <p style={{ textAlign: 'center' }}>Вартість раціону складає 499грн</p>
                      </div>
                    )
                    : null
                }
